...
bool operator==(const ::op3_tuning_module_msgs::JointOffsetPositionData_<ContainerAllocator1> & lhs, const ::op3_tuning_module_msgs::JointOffsetPositionData_<ContainerAllocator2> & rhs)
{
