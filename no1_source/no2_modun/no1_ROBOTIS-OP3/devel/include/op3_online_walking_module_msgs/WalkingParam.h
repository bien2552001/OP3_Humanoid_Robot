...
bool operator==(const ::op3_online_walking_module_msgs::WalkingParam_<ContainerAllocator1> & lhs, const ::op3_online_walking_module_msgs::WalkingParam_<ContainerAllocator2> & rhs)
{
  return lhs.dsp_ratio == rhs.dsp_ratio &&
    lhs.lipm_height == rhs.lipm_height &&
    lhs.foot_height_max == rhs.foot_height_max &&
    lhs.zmp_offset_x == rhs.zmp_offset_x &&
    lhs.zmp_offset_y == rhs.zmp_offset_y;
}
