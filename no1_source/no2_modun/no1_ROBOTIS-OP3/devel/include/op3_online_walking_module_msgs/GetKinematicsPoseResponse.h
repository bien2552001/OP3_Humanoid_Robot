...
bool operator==(const ::op3_online_walking_module_msgs::GetKinematicsPoseResponse_<ContainerAllocator1> & lhs, const ::op3_online_walking_module_msgs::GetKinematicsPoseResponse_<ContainerAllocator2> & rhs)
{
