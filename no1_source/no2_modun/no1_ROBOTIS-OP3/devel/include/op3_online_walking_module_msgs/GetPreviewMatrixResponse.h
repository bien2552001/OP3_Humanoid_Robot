...
bool operator==(const ::op3_online_walking_module_msgs::GetPreviewMatrixResponse_<ContainerAllocator1> & lhs, const ::op3_online_walking_module_msgs::GetPreviewMatrixResponse_<ContainerAllocator2> & rhs)
{
